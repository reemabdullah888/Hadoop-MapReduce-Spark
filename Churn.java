...
public class Churn {
  ...
  public static class TokenizerMapper 
	...
	int tenure = Integer.parseInt(toks[5]);
	String InternetService = toks[8];
	String churn= toks[20];
	if (churn.equals("Yes")){context.write(new Text(InternetService), new IntWritable(tenure));}
	}
